        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <?php foreach ($data_recipe as $data_recipe) : ?>
                    ...
                    <p class="card-text"><b>Recipe QTY:</b><br> <?=$data_recipe['recipe_qty']?></p>
                    <p class="card-text"><b>Recipe Total:</b><br><?= $data_recipe['recipe_total']?></p>
                    <p class="card-text"><b>Medicine Name:</b><br><?= $data_recipe['medicine_name']?></p>
                    <p class="card-text"><b>Patience Name:</b><br><?= $data_recipe['patience_name']?></p>
                    <p></p>
