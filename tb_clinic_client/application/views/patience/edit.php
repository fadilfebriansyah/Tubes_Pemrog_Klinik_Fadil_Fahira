            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="patience_id" class="col-sm-2 col-form-label">Nomor Pasien</label>
                        <div class="col-sm-5">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="patience_blood" name="patience_blood">
                                ...
                                <option value="A" <?php if (set_value('patience_blood') == "A") : echo "selected";
                                                    endif; ?>>A</option>
                                <option value="B" <?php if (set_value('patience_blood') == "B") : echo "selected";
                                                    endif; ?>>B</option>
                                <option value="O" <?php if (set_value('patience_blood') == "O") : echo "selected";
                                                    endif; ?>>O</option>
                                <option value="AB" <?php if (set_value('patience_blood') == "AB") : echo "selected";
                                                    endif; ?>>AB</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="patience_gender" name="patience_gender" value="L" <?php if (set_value('patience_gender') == "L") : echo "checked";
                                                                                                                                        endif; ?>>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="doctor_gender2" name="patience_gender" value="P" <?php if (set_value('patience_gender') == "P") : echo "checked";
                                                                                                                                        endif; ?>>
