            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="patience_blood" name="patience_blood">
                                ...
                                <option value="A" <?php if ($data_patience['patience_blood'] == "A") : echo "selected";
                                                    endif; ?>>A</option>
                                <option value="B" <?php if ($data_patience['patience_blood'] == "B") : echo "selected";
                                                    endif; ?>>B</option>
                                <option value="O" <?php if ($data_patience['patience_blood'] == "O") : echo "selected";
                                                    endif; ?>>O</option>
                                <option value="AB" <?php if ($data_patience['patience_blood'] == "AB") : echo "selected";
                                                    endif; ?>>AB</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="number" class="form-control" id="patience_age" name="patience_age" value="<?= $data_patience['patience_age']; ?>">
                            <small class="text-danger">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="patience_phone" name="patience_phone" value="<?= $data_patience['patience_phone']; ?>">
                            <small class="text-danger">
